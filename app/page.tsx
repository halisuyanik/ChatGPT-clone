...
function HomePage() {
  return (
    <div className="flex flex-col items-center text-sm  justify-center px-2 h-screen text-white">
      <h1 className="text-4xl mb-20">ChatGPT</h1>
      <div className="flex space-x-2 p-3 text-center">
        <div className="">
